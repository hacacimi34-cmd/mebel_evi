...
async function seed() {
  await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/mebel-evi');
  ...
  await Product.insertMany([
    ...
    },
    {
      ...
      description: { az: 'Venezia kreslоsu - oxumaq və istirahət üçün ideal. Rahat, estetik.', en: 'Venezia armchair - ideal for reading and relaxation. Comfortable and stylish.' },
  ...
  console.log('\n🎉 Seed tamamlandı!');
  console.log('👉 İndi: node server.js');
